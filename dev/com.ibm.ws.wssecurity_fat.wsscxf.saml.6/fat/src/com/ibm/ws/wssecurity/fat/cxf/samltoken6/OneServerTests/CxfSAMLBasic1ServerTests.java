...
package com.ibm.ws.wssecurity.fat.cxf.samltoken6.OneServerTests;
...
public class CxfSAMLBasic1ServerTests extends CxfSAMLBasicTests {
    ...
    public void CxfSAMLBasicTests_clockSkew_test() throws Exception {
		...
		if ("EE7OLDEhcache".equals(getEhcacheVersion())) {
		...
		} else if ("EE7NEWEhcache".equals(getEhcacheVersion())) {
