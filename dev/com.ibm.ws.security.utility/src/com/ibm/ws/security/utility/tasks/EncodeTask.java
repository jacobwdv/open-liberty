...
public class EncodeTask extends BaseCommandTask {
    ...
    private static final List<Set<String>> EXCLUSIVE_ARGUMENTS = Arrays.asList(
                                                                               new HashSet<String>(Arrays.asList(BaseCommandTask.ARG_KEY, BaseCommandTask.ARG_BASE64_KEY, BaseCommandTask.ARG_ENCRYPTION_XML_FILE)));

    private static final List<String> ARG_TABLE = Arrays.asList(BaseCommandTask.ARG_ENCODING, BaseCommandTask.ARG_KEY, BaseCommandTask.ARG_LIST_CUSTOM, BaseCommandTask.ARG_PASSWORD, BaseCommandTask.ARG_HASH_SALT, BaseCommandTask.ARG_HASH_ITERATION, BaseCommandTask.ARG_HASH_ALGORITHM,
                                                                BaseCommandTask.ARG_HASH_ENCODED, BaseCommandTask.ARG_KEYRING, BaseCommandTask.ARG_KEYRING_TYPE, BaseCommandTask.ARG_KEY_LABEL);
    private static final List<String> BETA_ARG_TABLE = Arrays.asList(BaseCommandTask.ARG_BASE64_KEY, BaseCommandTask.ARG_ENCRYPTION_XML_FILE);
        ...
        for (int i = 1; i < args.length; i++) {
            ...
            if (arg.startsWith("--")) {
                if (arg.equals(BaseCommandTask.ARG_NO_TRIM) || arg.equals(BaseCommandTask.ARG_LIST_CUSTOM)) {
                    ...
                    validateMutuallyExclusiveArgs(arg, result);
     ...
     */
    private void validateMutuallyExclusiveArgs(String arg, Map<String, String> inputMap) {
