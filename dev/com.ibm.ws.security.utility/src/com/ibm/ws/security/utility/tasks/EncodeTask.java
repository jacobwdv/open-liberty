...
public class EncodeTask extends BaseCommandTask {
     ...
     * Mirrors the runtime CKDSSecretKeyResolver in KeyStringResolverImpl — kept separate
     * to avoid a build dependency from security.utility onto zos.password.encryption.key.
     */
    private static final class CKDSSecretKeyResolver implements com.ibm.wsspi.security.crypto.SecretKeyResolver {
        ...
        CKDSSecretKeyResolver(String label) {
            this.label = label;
        }
