...
package com.ibm.ws.wssecurity.fat.cxf.samltoken5.TwoServerTests;
...
public class CxfSAMLAsymSignEnc2ServerTests extends CxfSAMLAsymSignEncTests {

    private static final Class<?> thisClass = CxfSAMLAsymSignEnc2ServerTests.class;
    ...
    public static void setupBeforeTest() throws Exception {
        ...
        copyMetaData = true;
        testSAMLServer2 = commonSetUp("com.ibm.ws.wssecurity_fat.saml.2servers", "server_2_AsymSignEnc.xml", SAMLConstants.SAML_ONLY_SETUP, SAMLConstants.SAML_SERVER_TYPE, extraApps2, extraMsgs2, SAMLConstants.EXAMPLE_CALLBACK, SAMLConstants.EXAMPLE_CALLBACK_FEATURE);
        copyMetaData = true;
        testSAMLServer = commonSetUp("com.ibm.ws.wssecurity_fat.saml", "server_1_AsymSignEnc.xml", SAMLConstants.SAML_ONLY_SETUP, SAMLConstants.SAML_SERVER_TYPE, extraApps, extraMsgs);
        ...
        testSAMLServer2.addIgnoredServerExceptions(SAMLMessageConstants.CWWKS5207W_SAML_CONFIG_IGNORE_ATTRIBUTES, SAMLMessageConstants.CWWKG0101W_CONFIG_NOT_VISIBLE_TO_OTHER_BUNDLES, SAMLMessageConstants.CWWKF0001E_FEATURE_MISSING, SAMLMessageConstants.CWWKS5900W_ALGORITHM_INSECURE);
